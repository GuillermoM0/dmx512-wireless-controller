...
#define DMX_BUFFER_SIZE			(DMX_MAX_CHANNELS + 1)	// +1 for Start Code
...
#define DMX_TX_GPIO_Port		MAX485_TX_GPIO_Port
#define DMX_TX_Pin				MAX485_TX_Pin
#define DMX_UART_AF				GPIO_AF8_USART6
#endif

#ifndef DMX_DE_GPIO_Port
#define DMX_DE_GPIO_Port		MAX485_DE_GPIO_Port
#define DMX_DE_Pin				MAX485_DE_Pin
#endif

#ifndef DMX_RE_GPIO_Port
#define DMX_RE_GPIO_Port		MAX485_RE_GPIO_Port
#define DMX_RE_Pin				MAX485_RE_Pin
#endif
/** @} */
